...
const categoriesValue = ref<any>(null)
...
const save = async () => {
  categoriesStore.addWorksData(dynamicValidateForm)
}
...
const handleChange = (value: any[]) => {
  dynamicValidateForm.category = value[0]
  dynamicValidateForm.subcategory = value[1]
  dynamicValidateForm.categoriesValue = value
}
const schoolHandleChange = (value: any[]) => {
  dynamicValidateForm.school = value[0]
}
const studentHandleChange = (value: any[]) => {
  dynamicValidateForm.author = value[0]
}
const teacherHandleChange = (value: any[]) => {
  dynamicValidateForm.teacher = value[0]
}
</script>
<template>
    ...
    <el-form ref="formRef" :model="dynamicValidateForm" label-width="160px">
      <el-row>
        <el-col :span="8">
          ...
          >
            <el-cascader v-model="categoriesValue" :options="options" @change="handleChange" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item
